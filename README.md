...
- `/study/themes/[id]`: one page per theme with key points, the classic trap, decision diagrams (26 in total, including orthodontic, trauma, antibiotic, behavior, and consent decision trees), a flashcard deck, and sources.
